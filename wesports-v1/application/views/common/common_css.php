...
<!--[if lte IE 8]><script src="<?php echo base_url('asset/assets/js/ie/html5shiv.js');?>"></script>
<script src="<?php echo base_url('asset/javascript/respond.min.js');?>"></script><![endif]-->
<!--[if lte IE 8]><link rel="stylesheet" href="<?php echo base_url('asset/assets/css/ie8.css');?>" /><![endif]-->
